...
HD_PWD='C:/Users/tim/fpgaprojects/useful-components/UART/UART.runs/uart_fifo_fifo_generator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_fifo_fifo_generator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_fifo_fifo_generator_0_0.tcl
